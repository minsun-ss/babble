...
Revision ID: 5de1423e00b7
Revises: 450bd6051482
Create Date: 2025-04-18 13:21:06.668700
...
def upgrade() -> None:
    ...
    op.add_column('docs', sa.Column('project_name', sa.String(length=50), server_default=sa.text('"Other"'), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('docs', sa.Column('project_team', mysql.VARCHAR(length=50), server_default=sa.text("'Other'"), nullable=False))
